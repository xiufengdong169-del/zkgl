    ...
    return withTransaction(this.pool, async (connection) => {
      switch (action) {
        ...
        case 'project.close.create': {
          ...
          const check={acceptancePassed,archivePassed:Boolean(input.archiveCheckPassed),outstandingReceivable:receivedAmount<contractAmount,unreturnedDeposit,openIssues};validateProjectClose(check,input.closeType,input.openItems,check.outstandingReceivable||unreturnedDeposit||openIssues?'COMPANY_PRINCIPAL':undefined)
